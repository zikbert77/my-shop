                           ...
                           <div class="row">
                               ...
                               <?php if(!empty($product_in_category)): ?>
                                    ...
                                    <?php foreach($product_in_category as $product): ?>
                                        ...
                                        <div class="col-good-container col-xs-12 col-sm-6 col-lg-3">
                                            <div class="good-container">
                                                ...
                                                <div class="good-footer">
                                                    ...
                                                    <?php if(Cart::checkProduct($product['product_id'])): ?>
                                                        <a href="/product/<?php echo $product['product_id'] . '/'; ?>" class="btn btn-success btn-block">У корзині <i class="fa fa-check" aria-hidden="true"></i></a>
                                                    <?php else: ?>
                                                        <a href="/product/<?= $product['product_id'] . '/' ?>" class="btn btn-primary btn-block">Детальніше </a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
